...
### Downloads and links
- <i class="fa-solid fa-file" aria-hidden="true"></i> [Paper](http://iribis.github.io/files/regression-based_Monte_Carlo_integration/regression-based_Monte_Carlo_integration.pdf)<br />
