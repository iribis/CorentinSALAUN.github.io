...
### Downloads and links
- <i class="fa-sharp fa-solid fa-file"></i> [Paper](http://iribis.github.io/files/regression-based_Monte_Carlo_integration/regression-based_Monte_Carlo_integration.pdf)<br />
